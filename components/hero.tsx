      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-10 px-4 py-16 sm:px-6 lg:grid-cols-2 lg:py-24">
        <Reveal className="flex flex-col gap-6">
          ...
          <h1 className="text-balance font-heading text-3xl font-bold leading-tight sm:text-4xl lg:text-5xl">
            Trusted By Families Since 1999. Affordable Excellence for Every Child.
          </h1>
          <p className="max-w-xl text-pretty leading-relaxed text-primary-foreground/80">
            Welcome to {school.name}. We combine future-ready learning like Robotics and Smart
            Classes with deep moral values to ensure financial constraints never limit your
            child&apos;s grand future.
          </p>
          <div className="flex flex-col gap-3 sm:flex-row">
            ...
            <Button
              ...
              render={
                <a href={school.whatsapp} target="_blank" rel="noopener noreferrer">
        ...
        <Reveal delay={150} className="relative">
          <div className="absolute -inset-3 rounded-3xl bg-accent/20 blur-xl" aria-hidden="true" />
          <img
            src="/images/hero-students.png"
            alt="Smiling students of K.P.Y. Jansahyogi Inter College in a bright classroom"
            className="relative aspect-4/3 w-full rounded-3xl border border-primary-foreground/10 object-cover shadow-2xl"
          />
        </Reveal>
      </div>
    </section>
